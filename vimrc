...
syntax on                       " Use syntax highlighting for known file types
set background=dark             " Set dark background for syntax highlighting

set showcmd                     " Show (partial) command in status line.
set showmatch                   " Show matching brackets. !!! Breaks select with mouse in iterm
...
"hi Tab gui=underline guifg=235 ctermbg=235

"highlight TabWhitespace ctermbg=235 guifg=235
"autocmd ColorScheme * highlight TabWhitespace ctermbg=235 guifg=235
"match TabWhitespace /\t/
...
set noautoindent		" don't get on my nerves!
"set autoindent                  " use normal indent
"set smartindent                 " use not-so-dumb-indent
"set filetype?                   " show current indentation setting on startup
"filetype plugin indent on       " use indentation plugin
"autocmd FileType conf setlocale noexpandtab tabstop=8 shiftwidth=8
"autocmd FileType php setlocale expandtab tabstop=4 shiftwidth=4
